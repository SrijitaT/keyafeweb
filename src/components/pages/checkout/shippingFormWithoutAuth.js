...
class ShippingFormWithoutAuth extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
        ...
        return (
            <form>
                <div className="form-row">
                    ...
                    <div className="form-group col-md-6">
                        <h5>Already have an account?  <LoginRegisterModal btnName="Login" variant="outline-light" title="Login Form"  icon = "no"/></h5>
                    </div>
            </div>
            <div className="form-row">
...
ShippingFormWithoutAuth.propTypes = {};

export default ShippingFormWithoutAuth;
